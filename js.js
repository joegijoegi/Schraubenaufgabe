...
function calc() {
    ...
    if (!isvalidnumber(screw)) document.getElementById("screw").innerText = "Bitte Zahl bei Schrauben angeben.";
    if (!isvalidnumber(screwwnut)) document.getElementById("screwnut").innerText = "Bitte Zahl bei Mutter angeben.";
    if (!isvalidnumber(grommet)) document.getElementById("grommet").innerText = "Bitte Zahl bei Unterlagsschrauben angeben.";
